<!----><!-- Single document--><!--///////////////////////////////////////--><!DOCTYPE html><html><head><title>pako 0.2.6 API documentation</title><meta charset="utf-8"><meta name="generator" content="ndoc"><style rel="stylesheet">p {
  margin: 0 0 11px;
...
.menu a.section {
  ...
  background: -webkit-gradient(linear, left top, left bottom, color-stop(0.7, #000), color-stop(1, #444)) repeat scroll 0 0 transparent;
  background: -webkit-linear-gradient(top, #000 70%, #444 100%) repeat scroll 0 0 transparent;
  background: -moz-linear-gradient(top, #000 70%, #444 100%) repeat scroll 0 0 transparent;
  background: -o-linear-gradient(top, #000 70%, #444 100%) repeat scroll 0 0 transparent;
  background: -ms-linear-gradient(top, #000 70%, #444 100%) repeat scroll 0 0 transparent;
  background: linear-gradient(top, #000 70%, #444 100%) repeat scroll 0 0 transparent;
  color: #ccc;
  font-weight: bold;
...
.note {
  ...
  -webkit-box-shadow: 0 0 3px #eef;
  box-shadow: 0 0 3px #eef;
}
.related-to {
  background-color: #fff6de;
  border: 1px solid #cc9;
  -webkit-box-shadow: 0 0 3px #fff6de;
...
}),n=s=l=u=r=o=null,t}({});var B=/(?:\{[\s\S]*\}|\[[\s\S]*\])$/,P=/([A-Z])/g;function R(e,n,r,i){if(x.acceptData(e)){var o,a,s=x.expando,l=e.nodeType,u=l?x.cache:e,c=l?e[s]:e[s]&&s;if(c&&u[c]&&(i||u[c].data)||r!==t||"string"!=typeof n)return c||(c=l?e[s]=p.pop()||x.guid++:s),u[c]||(u[c]=l?{}:{toJSON:x.noop}),("object"==typeof n||"function"==typeof n)&&(i?u[c]=x.extend(u[c],n):u[c].data=x.extend(u[c].data,n)),a=u[c],i||(a.data||(a.data={}),a=a.data),r!==t&&(a[x.camelCase(n)]=r),"string"==typeof n?(o=a[n],null==o&&(o=a[x.camelCase(n)])):o=a,o}}function W(e,t,n){if(x.acceptData(e)){var r,i,o=e.nodeType,a=o?x.cache:e,s=o?e[x.expando]:x.expando;if(a[s]){if(t&&(r=n?a[s]:a[s].data)){x.isArray(t)?t=t.concat(x.map(t,x.camelCase)):t in r?t=[t]:(t=x.camelCase(t)